# Anonymity Networks with Lethean

Currently only Tor and I2P have been integrated into Lethean. The usage of
...
system clock is fairly accurate - many peers on the Lethean network should have
similar timestamps.
