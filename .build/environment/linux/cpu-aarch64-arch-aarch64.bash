...
mkdir -p "${SRC_DIR}/aarch64"

# OpenSSL Settings
OPENSSL_VERSION=1.1.0h
OPENSSL_HASH=5835626cde9e99656585fc7aaa2302a73a7e1340bf8c14fd635a62c66802a517
OPENSSL_SRC_DIR_ARM8="${SRC_DIR}/aarch64"
OPENSSL_INSTALL_DIR_ARM8="${INSTALL_DIR}/aarch64/openssl-${OPENSSL_VERSION}"
...
BOOST_SRC_DIR_ARM8="${SRC_DIR}/aarch64"
BOOST_INSTALL_DIR_ARM8="${INSTALL_DIR}/aarch64/boost_${BOOST_VERSION}"
